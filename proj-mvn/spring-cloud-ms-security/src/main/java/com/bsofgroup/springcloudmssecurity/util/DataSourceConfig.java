...
public class DataSourceConfig {
	...
	public DataSource dataSource() {
		...
		ResponseEntity<DataConexion> responseEntity = new RestTemplate().getForEntity("http://localhost:8084/mproperties/dataconexionpostgres",DataConexion.class);
		DataConexion datosConexion = responseEntity.getBody();
