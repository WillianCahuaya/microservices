...
import com.bsoftgroup.springbootjwtsecurity.util.Conexion;
...
public class UserDetailDao implements UserDetailDaoInterface {
	...
	public Usuario getUsuario(String username) {
		...
		try {
			...
			String SQL = "Select username, password from esq_pwj_040519.TBL_USUARIO where username=? order by id";
